...
export class FarmerDashboard implements OnInit {
  ...
  // ⭐ NEW: Smart Dashboard Data
  marketPrices = [
    { crop: 'Premium Rice', price: '₹4,200', unit: 'Quintal', trend: 'up', change: '+2.4%' },
    { crop: 'Organic Wheat', price: '₹2,850', unit: 'Quintal', trend: 'down', change: '-1.2%' },
    { crop: 'Red Tomatoes', price: '₹1,400', unit: 'Crate', trend: 'up', change: '+15.0%' }
  ];
  ...
  weatherData = {
    ...
    forecast: [
      { day: 'Tom', icon: 'sun', status: 'Optimal' },
      { day: 'Sat', icon: 'cloud-rain', status: 'Slight Rain' },
      { day: 'Sun', icon: 'thermometer', status: 'Heatwave' }
    ]
  };
